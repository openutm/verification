...
const sectionTooltips: Record<string, string> = {
    ...
    air_traffic: 'Default air traffic simulator settings: number of aircraft, simulation duration, and sensor configuration. Per-step overrides go in scenario YAML arguments.',
};
...
export const ConfigEditor: React.FC<ConfigEditorProps> = ({ config, onUpdateConfig }) => {
    ...
    const updateSensorIds = (value: string) => {
        ...
        updateAirTrafficSettings('sensor_ids', ids);
    };
